...
w_pos = []
w_neg = []
def dictConvert(key_p,key_n,text_file_p,text_file_n):
    with open(text_file_p) as tf_p, open(text_file_n) as tf_n:
        
        w_pos.extend([words.strip() for words in list(tf_p)])
        w_neg.extend([words.strip() for words in list(tf_n)])

    d_p[str(key_p)] = w_pos
    d_n[str(key_n)] = w_neg
    return(d_p,d_n) 
    
file_pos = os.getcwd() + '\\' + 'positive-words.txt'
file_neg = os.getcwd() + '\\' + 'negative-words.txt'

pos_words_dict, neg_words_dict = dictConvert('pos','neg',file_pos,file_neg)

# if 'good' in pos_words_dict['pos']:
#     print("Present")

# print(pos_words_list[:10])
# print('\n')
# print('****************************')
# print('\n')
# print(neg_words_list[:10])